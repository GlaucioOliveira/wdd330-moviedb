import{a as o,g as r,m as d,d as l}from"./auth-c446acf8.js";import"./main-4024126f.js";function c(t,s=!1){o().then(e=>{let i=e;if(s&&(i=e.filter(a=>a.wishlist)),!i||i.length===0){document.querySelector(t).innerHTML="<p>Wishlist is empty.</p>";return}const n=i.map(a=>h(a));document.querySelector(t).innerHTML=n.join("")}).catch(e=>{console.error("Error fetching Wish List:",e),document.querySelector(t).innerHTML="<p>Failed to load Wish List. Please try again later.</p>"})}function h(t){return`<tr>
